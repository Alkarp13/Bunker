...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('game_state', models.CharField(choices=[('R', 'recruiting_players'), ('P', 'ready_to_play'), ('S', 'game_start'), ('E', 'game_end')], default='R', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Profesions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('male', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], default='M', max_length=1)),
                ...
                ('lobby', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='db_models.Lobby')),
            ],
        ),
        migrations.AddField(
            model_name='userprofile',
            name='linked_lobby',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='db_models.Lobby'),
        ),
        migrations.AddField(
            model_name='userprofile',
